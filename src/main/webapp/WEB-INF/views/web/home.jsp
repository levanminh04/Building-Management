                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                ...
                                <select class="search-option" name="search-option" id="search-option1">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                ...
                                <select class="search-option" name="search-option" id="search-option2">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="product1 vip">
                                            <div class="product1-image no-bg">
                                                <img src="${building.avt}" alt="${building.name}" class="img-fluid"
                    ...
                    <div class="card text-white" style="border-radius: 1rem; background-color: #35bf76;">
                        <div class="card-body p-2 px-5 text-center">
                            <div class="md-5 md-4 mt-4 pb-2">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center mb-4 py-2">
                                ...
                                <div class="form-outline form-white mb-2">
                                    <label class="form-label" for="typeEmailX2">Password</label>
                                    <input type="password" id="typeEmailX1" class="form-control form-control-lg" />
                                </div>

                                <div class="form-outline form-white mb-2">
                                    <label class="form-label" for="typeEmailX1">Repeat your password</label>
                                    <input type="password" id="typeEmailX2" class="form-control form-control-lg" />
                                </div>

                                <div class="d-flex justify-content-center align-items-center mb-4">
                                    <input class="form-check-input me-2" type="checkbox" id="form2Example3cg" />
                                    <label for="form2Example3cg" class="form-check-label m-0">
